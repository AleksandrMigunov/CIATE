...
void MainWindow::on_pushButton_oe_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info22 = "Оь оь (only in Chechen alphabet): close-mid central rounded vowel / high-mid central rounded vowel; "
...
void MainWindow::on_pushButton_ue_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info30 = "Уь уь (only in Chechen alphabet): close front rounded vowel, or high front rounded vowel; "
...
void MainWindow::on_pushButton_jue_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info46 = "Юь юь (only in Chechen alphabet): in the beginning of a word or after a vowel: a combination of voiced palatal approximant and "
...
void MainWindow::on_pushButton_b1_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info50 = "БІ бІ (not in alphabet): voiced bilabial plosive / stop (pronounced as English b) and "
...
void MainWindow::on_pushButton_v1_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info51 = "ВІ вІ (not in alphabet): voiced labiodental fricative (pronounced as English v) and "
                         "voiced pharyngeal fricative (pronounced as Hebrew ayin)";
...
void MainWindow::on_pushButton_d1_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info52 = "ДІ дІ (not in alphabet): voiced dental plosive / stop (pronounced as English d) and "
                         "voiced pharyngeal fricative (pronounced as Hebrew ayin)";
...
void MainWindow::on_pushButton_zh1_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info53 = "ЖІ жІ (not in alphabet): voiced postalveolar fricative (sibilant), pronounced as s in measure or "
...
void MainWindow::on_pushButton_z1_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info54 = "ЗІ зІ (not in alphabet): voiced alveolar fricative (sibilant) prounounced as z or voiced alveolar affricate (sibilant) pronounced as d and z together and "
                         "voiced pharyngeal fricative (pronounced as Hebrew ayin)";
...
void MainWindow::on_pushButton_j1_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info55 = "ЙІ йІ (not in alphabet): voiced palatal approximant (pronounced as y) and "
                         "voiced pharyngeal fricative (pronounced as Hebrew ayin)";
...
void MainWindow::on_pushButton_m1_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info56 = "МІ мІ (not in alphabet): voiced bilabial nasal (pronounced as m) and "
                         "voiced pharyngeal fricative (pronounced as Hebrew ayin)";
...
void MainWindow::on_pushButton_n1_clicked()
{
    ...
    if (Info_On) {
        ...
        QString info57 = "НІ нІ (not in alphabet): voiced alveolar nasal (pronounced as n) and "
                         "voiced pharyngeal fricative (pronounced as Hebrew ayin)";
